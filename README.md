# Awesome AI Learning Tools [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
A curated list of awesome AI-powered learning tools, platforms, and resources for education, skill development, and knowledge enhancement.
...
- [Fireflies.ai](https://fireflies.ai/) 🎓 🟡 👂 💵 🌐 - AI meeting assistant that records, transcribes, and analyzes conversations for learning
- [EdApp](https://www.edapp.com/) 🎓 🟢 🎯 💵 🌐 📱 - Microlearning platform with AI-powered content creation and analytics
- [Continu](https://www.continu.co/) 🎓 🟡 🎯 💵 🌐 - AI-powered training platform for customer education and employee development
- [Zavvy](https://zavvy.io/) 🎓 🟡 💬 💵 🌐 - AI-powered platform for onboarding, training, and employee development
- [LearnUpon](https://www.learnupon.com/) 🎓 🟡 🎥 💎 🌐 - Learning management system with AI features for course creation and engagement
- [Thinkific](https://www.thinkific.com/) 🎓 🟡 🎥 💵 🌐 - Online course platform with AI tools for content creation and student engagement
- [Kajabi](https://kajabi.com/) 🎓 🟡 🎥 💎 🌐 - All-in-one platform for creating and selling online courses with AI-powered marketing
- [Paradiso LMS](https://www.paradisosolutions.com/) 🎓 🟡 🎥 💎 🌐 - Enterprise learning platform with AI-powered personalization and analytics
- [Absorb LMS](https://www.absorblms.com/) 🎓 🟡 🎥 💎 🌐 - Cloud-based learning management system with AI-enhanced content delivery
...
- [NotebookLM](https://notebooklm.google/) 🤖 🟡 📖 💰 🌐 - Google's AI-powered notebook that transforms documents and notes into interactive conversations
- [Langua](https://langua.ai/) 🤖 🟢 💬 💵 🌐 📱 - AI language learning companion for practicing conversations and improving fluency
- [AI Anki](https://ai-anki.top/) 🤖 🟢 📖 💰 🌐 - AI-powered flashcard system that generates intelligent spaced repetition cards
...
- [Knowji](https://www.knowji.com/) 🎮 🟢 📖 💵 🌐 📱 - AI-powered vocabulary learning app with spaced repetition and visual mnemonics
...
- [Course Hero](https://www.coursehero.com/) 📊 🟢 📖 💵 🌐 📱 - AI-powered study platform with course-specific resources, practice problems, and tutoring
- [TurboLearn AI](https://www.turbolearn.ai/) 📊 🟢 📖 💵 🌐 - AI tool that generates summaries, flashcards, and study materials from any content
- [Eduaide.AI](https://www.eduaide.ai/) 📊 🟢 💬 💰 🌐 - AI teaching assistant that creates lesson plans, assessments, and educational content
- [Mindgrasp](https://www.mindgrasp.ai/) 📊 🟢 📖 💵 🌐 📱 - AI tool that instantly summarizes videos, articles, and documents into key points
