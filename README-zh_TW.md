# 精選的 AI 學習工具 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
精選的優秀 AI 驅動學習工具、平台和資源列表，用於教育、技能發展和知識提升。
...
- [Fireflies.ai](https://fireflies.ai/) 🎓 🟡 👂 💵 🌐 - AI會議助手，可錄製、轉錄和分析對話內容用於學習
- [EdApp](https://www.edapp.com/) 🎓 🟢 🎯 💵 🌐 📱 - 微學習平台，提供AI驅動的內容創建和分析功能
- [Continu](https://www.continu.co/) 🎓 🟡 🎯 💵 🌐 - AI驅動的客戶教育和員工培訓平台
- [Zavvy](https://zavvy.io/) 🎓 🟡 💬 💵 🌐 - AI驅動的入職、培訓和員工發展平台
- [LearnUpon](https://www.learnupon.com/) 🎓 🟡 🎥 💎 🌐 - 學習管理系統，具備AI課程創建和參與功能
- [Thinkific](https://www.thinkific.com/) 🎓 🟡 🎥 💵 🌐 - 在線課程平台，提供AI內容創建和學生參與工具
- [Kajabi](https://kajabi.com/) 🎓 🟡 🎥 💎 🌐 - 創建和銷售在線課程的一體化平台，配備AI驅動的營銷功能
- [Paradiso LMS](https://www.paradisosolutions.com/) 🎓 🟡 🎥 💎 🌐 - 企業學習平台，提供AI個性化分析和學習路徑
- [Absorb LMS](https://www.absorblms.com/) 🎓 🟡 🎥 💎 🌐 - 基於雲的學習管理系統，具備AI增強的內容傳遞功能
...
- [NotebookLM](https://notebooklm.google/) 🤖 🟡 📖 💰 🌐 - Google的AI驅動筆記本，將文件和筆記轉化為互動式對話
- [Langua](https://langua.ai/) 🤖 🟢 💬 💵 🌐 📱 - AI語言學習夥伴，用於練習對話和提高流利度
- [AI Anki](https://ai-anki.top/) 🤖 🟢 📖 💰 🌐 - AI驅動的抽認卡系統，生成智能間隔重複卡片
...
- [Knowji](https://www.knowji.com/) 🎮 🟢 📖 💵 🌐 📱 - AI驅動的詞彙學習應用程式，具備間隔重複和視覺記憶法
...
- [Course Hero](https://www.coursehero.com/) 📊 🟢 📖 💵 🌐 📱 - AI驅動的學習平台，提供課程特定資源、練習題目和輔導
- [TurboLearn AI](https://www.turbolearn.ai/) 📊 🟢 📖 💵 🌐 - 從任何內容生成摘要、抽認卡和學習材料的AI工具
- [Eduaide.AI](https://www.eduaide.ai/) 📊 🟢 💬 💰 🌐 - AI教學助手，創建課程計劃、評估和教育內容
- [Mindgrasp](https://www.mindgrasp.ai/) 📊 🟢 📖 💵 🌐 📱 - 即時將影片、文章和文件總結為要點的AI工具
