# Ferramentas de Aprendizagem IA Incríveis [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
Uma lista curada de ferramentas de aprendizagem, plataformas e recursos incríveis alimentados por IA para educação, desenvolvimento de habilidades e aprimoramento de conhecimento.
...
- [NotebookLM](https://notebooklm.google/) 🤖 🟡 📖 💰 🌐 - Caderno AI do Google que transforma documentos e anotações em conversas interativas
- [Langua](https://langua.ai/) 🤖 🟢 💬 💵 🌐 📱 - Companheiro de aprendizado de idiagens IA para praticar conversas e melhorar fluência
- [AI Anki](https://ai-anki.top/) 🤖 🟢 📖 💰 🌐 - Sistema de flashcards IA que gera cartões de repetição espaçada inteligentes
...
- [Knowji](https://www.knowji.com/) 🎮 🟢 📖 💵 🌐 📱 - Aplicativo de aprendizado de vocabulário IA com repetição espaçada e mnemônicos visuais
...
- [Course Hero](https://www.coursehero.com/) 📊 🟢 📖 💵 🌐 📱 - Plataforma de estudo IA com recursos específicos de curso, problemas práticos e tutoria
- [TurboLearn AI](https://www.turbolearn.ai/) 📊 🟢 📖 💵 🌐 - Ferramenta IA que gera resumos, flashcards e materiais de estudo de qualquer conteúdo
- [Eduaide.AI](https://www.eduaide.ai/) 📊 🟢 💬 💰 🌐 - Assistente de professor IA que cria planos de aula, avaliações e conteúdo educacional
- [Mindgrasp](https://www.mindgrasp.ai/) 📊 🟢 📖 💵 🌐 📱 - Ferramenta IA que resume instantaneamente vídeos, artigos e documentos em pontos principais
