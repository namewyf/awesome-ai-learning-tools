# 최고의 AI 학습 도구 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
교육, 기술 개발, 지식 향상을 위한 AI 기반 학습 도구, 플랫폼, 리소스의 큐레이션 목록입니다.
...
- [NotebookLM](https://notebooklm.google/) 🤖 🟡 📖 💰 🌐 - Google의 AI 기반 노트북. 문서와 노트를 대화형 상호작용으로 변환
- [Langua](https://langua.ai/) 🤖 🟢 💬 💵 🌐 📱 - AI 언어 학습 동반자. 대화 연습 및 유창성 향상
- [AI Anki](https://ai-anki.top/) 🤖 🟢 📖 💰 🌐 - AI 기반 플래시카드 시스템. 지능형 간격 반복 카드 생성
...
- [Knowji](https://www.knowji.com/) 🎮 🟢 📖 💵 🌐 📱 - AI 기반 어휘 학습 앱. 간격 반복 및 시각적 기억술 제공
...
- [Course Hero](https://www.coursehero.com/) 📊 🟢 📖 💵 🌐 📱 - AI 기반 학습 플랫폼. 과목별 리소스, 연습 문제, 튜터링 제공
- [TurboLearn AI](https://www.turbolearn.ai/) 📊 🟢 📖 💵 🌐 - 모든 콘텐츠에서 요약, 플래시카드, 학습 자료를 생성하는 AI 도구
- [Eduaide.AI](https://www.eduaide.ai/) 📊 🟢 💬 💰 🌐 - AI 교사 도우미. 수업 계획, 평가, 교육 콘텐츠 생성
- [Mindgrasp](https://www.mindgrasp.ai/) 📊 🟢 📖 💵 🌐 📱 - 동영상, 기사, 문서를 핵심 포인트로 즉시 요약하는 AI 도구
